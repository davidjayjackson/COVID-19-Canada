---
title: "Canada's COVID-19 Vaccine Rollout"
author: "David Jackson"
date: "03/07/2021 12:05 PM/EST"
output: 
  html_document: 
    fig_width: 9
    fig_height: 7
...
SWE <- dbGetQuery(db,"select * from OWID where location ='Canada'")
...
```{r}
p2 <- VAC %>% filter(people_vaccinated >=0) %>% ggplot() + geom_line(aes(x=date,y=people_vaccinated,col="People Vacc.")) +
...
p3 <- VAC  %>% filter(PeoplePercent >=0.01) %>%
